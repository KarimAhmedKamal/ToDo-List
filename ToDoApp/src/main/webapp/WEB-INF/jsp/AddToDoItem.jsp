	...
	<form:form action="/saveToDoItem" method="post" modelAttribute="todo">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-6">
					<form:input path="title" type="text" id="title" class="form-control input-sm" required="required"/>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-6">
					<form:input path="date" type="date" id="date" class="form-control input-sm" required="required"/>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-6">
					<form:input path="status" type="text" id="status" class="form-control input-sm" value="Incomplete"/>
				</div>
			</div>
		</div>
